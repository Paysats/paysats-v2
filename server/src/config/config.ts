...
const DEV_MONGODB_URI = process.env.DEV_MONGODB_URI || "mongodb://localhost:27017/paysats-dev";
const PROD_MONGODB_URI = process.env.PROD_MONGODB_URI || "mongodb://localhost:27017/paysats-prod";
...
// app config export
const app = {
  NAME: process.env.APP_NAME || "paysats",
...
const email = {
  ...
  FROM_EMAIL: process.env.FROM_EMAIL || 'paysats <onboarding@paysats.xyz>',
  SUPPORT_EMAIL: process.env.SUPPORT_EMAIL || 'support@paysats.xyz',
};
